...
Looks like **/var/www/html/** is the folder where the assets of our default page are stored. Next, we will head there and cmd **ls -la**
...
and we'll kick the daemon with **service.running**. **watch** is used to make Salt watch for changes made in file sshd_config and sshd_banner and kick the daemon if
