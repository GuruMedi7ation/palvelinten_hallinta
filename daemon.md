...
Next, we get our own IP with **hostname -i** to have an address to visit with Lynx
...
It seems all that we got was "Ticotchid."... Whatever that means!
...
**update** It's funny, but our Super Secret Test Site works just fine when accessed from slave01, I just need to try to access the right address for it.

Let's proceed to create a state file for our minion and not waste time troubleshooting this!
